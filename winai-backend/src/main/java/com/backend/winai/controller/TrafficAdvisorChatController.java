...
import com.backend.winai.service.TrafficAdvisorChatService;
...
@RestController
@RequestMapping("/api/v1/traffic/chat")
@RequiredArgsConstructor
@CrossOrigin(origins = "*")
public class TrafficAdvisorChatController {

    private final TrafficAdvisorChatService chatService;
