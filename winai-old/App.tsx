      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 z-40">
           ...
           <div className="flex items-center gap-6">
             <button className="text-gray-400 hover:text-emerald-600 transition-all relative p-2 hover:bg-gray-50 rounded-xl">
               <Bell size={20} />
               <span className="absolute top-2 right-2 w-3.5 h-3.5 bg-red-500 rounded-full border-2 border-white text-[8px] flex items-center justify-center text-white font-bold">3</span>
             </button>
             <div className="flex items-center gap-3 pl-6 border-l border-gray-100">
               ...
               <div className="w-10 h-10 rounded-xl bg-emerald-100 flex items-center justify-center overflow-hidden border-2 border-emerald-500 shadow-lg shadow-emerald-500/10">
                 <img src="https://picsum.photos/seed/executive/100/100" alt="Avatar" className="w-full h-full object-cover" />
               </div>
