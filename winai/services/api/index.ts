...
export type { TrafficMetrics, MetricDetail, DailyPerformance, CreateCampaignRequest, CampaignListItem, CampaignsListResponse, AiRecommendation } from './marketing.service';
