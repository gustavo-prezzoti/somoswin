...
export type { TrafficMetrics, MetricDetail, DailyPerformance, CreateCampaignRequest, CampaignListItem, CampaignsListResponse, AiRecommendation, MetricsDateRange } from './marketing.service';
