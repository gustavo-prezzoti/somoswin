...
const AdminGlobalNotifications = () => {
    ...
    const loadConfig = async () => {
        ...
        setIsLoading(true);
        try {
            const data: GlobalNotificationConfig | null = await globalNotificationService.getConfig(selectedCompanyId);
            if (data) {
                setFormData({
    ...
    const updateForm = (field: keyof GlobalNotificationConfigRequest, value: string | boolean) => {
