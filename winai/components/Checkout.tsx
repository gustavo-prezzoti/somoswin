         ...
         <main className="flex-1 max-w-6xl mx-auto w-full p-8 md:p-16 grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <form onSubmit={handleFinalize} className="bg-white p-10 md:p-14 rounded-[48px] border border-gray-100 shadow-2xl space-y-8">
               ...
               <div className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     <div className="space-y-2">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block px-2">Criar Senha</label>
                        <div className="relative group">
                           ...
                           <input
                              ...
                              required
                              type="password"
                              className="w-full pl-12 pr-6 py-4 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-emerald-500 outline-none transition-all font-medium text-sm"
                     ...
                     <div className="space-y-2">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block px-2">Confirmar Senha</label>
                        <div className="relative group">
                           <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-emerald-500 transition-colors" size={18} />
                           <input
               ...
               <div className="pt-8 border-t border-gray-50">
                  ...
                  <button
                     type="submit"
                     disabled={isLoading}
                     className="w-full bg-emerald-600 text-white font-black py-6 rounded-3xl text-xl flex items-center justify-center gap-3 hover:bg-emerald-700 transition-all shadow-2xl shadow-emerald-600/30 group disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                     {isLoading ? (
                        <>
