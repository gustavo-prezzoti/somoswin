                            ...
                            <form onSubmit={handleCreateOrUpdate} className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            type="date"
                                            className="w-full px-6 py-4 bg-gray-50 border-2 border-transparent focus:border-emerald-500 rounded-2xl outline-none transition-all font-bold text-gray-800"
                                            value={currentGoal.startDate || ''}
                                            onChange={(e) => setCurrentGoal({ ...currentGoal, startDate: e.target.value })}
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest px-2">Data Fim (Expiração)</label>
                                        <input
                                            type="date"
                                            className="w-full px-6 py-4 bg-gray-50 border-2 border-transparent focus:border-emerald-500 rounded-2xl outline-none transition-all font-bold text-gray-800"
